...
open class ElasticRefreshControl: UIView {
    ...
    open var elasticTintColor = UIColor(white: 0.5, alpha: 0.6) {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    open override func layoutSubviews() {
        ...
        spinner.center = CGPoint(x: bounds.width / 2.0, y: 0.75 * totalHeight)
    }
    ...
    open override func sizeToFit() {
        ...
        frame = CGRect(x: frame.origin.x, y: frame.origin.y, width: width, height: totalHeight)
    }
}
