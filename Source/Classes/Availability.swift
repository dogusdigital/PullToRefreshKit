...
public extension UIScrollView {
    ...
    public func setUpHeaderRefresh<T: UIView>(_ header: T, action: @escaping () -> Void) -> T where T: RefreshableHeader {
        ...
        let bounds = CGRect(x: 0, y: containFrame.height - header.frame.height, width: frame.width, height: header.frame.height)
        header.frame = bounds
...
extension UIScrollView {
    ...
    public func setUpLeftRefresh(_ action: @escaping () -> Void) -> DefaultRefreshLeft {
        let left = DefaultRefreshLeft(frame: CGRect(x: 0, y: 0, width: PullToRefreshKitConst.defaultLeftWidth, height: frame.height))
...
extension UIScrollView {
    ...
    public func setUpRightRefresh(_ action: @escaping () -> Void) -> DefaultRefreshRight {
        let right = DefaultRefreshRight(frame: CGRect(x: 0, y: 0, width: PullToRefreshKitConst.defaultLeftWidth, height: frame.height))
